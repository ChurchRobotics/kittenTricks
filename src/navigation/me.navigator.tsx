...
import { MeScreen } from '../scenes/me/me.component';
...
export const ProfileScreens = (): React.ReactElement => (
  <>
    <Stack.Screen name='Profile' component={Profile7Screen}/>
    <Stack.Screen name='ProfileSettings' component={ProfileSettings1Screen}/>

    <Stack.Screen name='Chat1' component={Chat1Screen}/>
  </>
);

export const MeNavigator = (): React.ReactElement => (
